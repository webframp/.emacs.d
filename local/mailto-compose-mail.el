;;;; mailto-compose-mail.el --- Sean Escriva
;;; Commentary:
;;   function to allow use of Emacs as mailto handler.
  ...
  (if (and (stringp mailto-url)
      ...
      (progn
        ...
        (let ((hdr-alist (rfc2368-parse-mailto-url mailto-url))
              (body "")
              to subject
                            ;; In addition to To, Subject and Body
              ;; these headers are
              ;; allowed:
...
(provide 'mailto-compose-mail)
;;; mailto-compose-mail.el ends here
